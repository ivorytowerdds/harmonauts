...
data_dir = path.abspath(path.join(base, 'data'))
...
if __name__ == "__main__":
    ...
    data = [data_dir, log_dir, json_dir]
    for d in data:
    ...
    pkl_file = path.join(data_dir,'punk_txs.pkl')
    ...
    page_info = path.join(data_dir,'punk_txs_page.pkl')
    ...
    txs_hash_info = path.join(data_dir,'punk_txs_hash.pkl')
